  ...
  return (
    <Layout userName={user?.name} userRole={user?.role}>
      <div className="space-y-5 px-4 pb-8 pt-2">
        ...
        {/* Divider */}
        <div className="h-px bg-linear-to-r from-amber-200 via-amber-100 to-transparent" />
        ...
        <div className="rounded-2xl border border-stone-200 bg-white p-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-3 border-b border-stone-100">
              ...
              <span className="text-sm font-mono font-semibold text-stone-700 truncate max-w-40">{user?.id}</span>
            </div>
